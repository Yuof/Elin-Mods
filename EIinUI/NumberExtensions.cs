...
public static class NumberExtensions
{
    ...
    /// <param name="decimalPlaces"> The number of decimal places to include - <i> defaults to <c> 2 </c> </param>
    ...
    public static string FormatNumber(this int numberToFormat, int decimalPlaces = 2) => FormatNumber((long)numberToFormat, decimalPlaces);
