    ...
    public static string GetTranslation(string id)
    {
        ...
        return lang switch
        {
            "JP" => id switch
            {
                ...
                nameof(AutoExplorerConfig.StopOnUnusableShrine) => "自動使用できない神殿（素材・防具）の隣で停止するべきですか？",
                nameof(AutoExplorerConfig.HandleStatues) => "オートエクスプローラーは神像を使用するべきですか？",
                nameof(AutoExplorerConfig.HandleChests) => "オートエクスプローラーは宝箱を解錠して回収するべきですか？",
                nameof(AutoExplorerConfig.AutoDescend) => "フロアを攻略したら次の階に降りるべきですか？",
            ...
            "CN" => id switch
            {
                ...
                nameof(AutoExplorerConfig.StopOnUnusableShrine) => "自动探索是否应停在无法自动使用的神殿（材料/防具）旁？",
                nameof(AutoExplorerConfig.HandleStatues) => "自动探索是否应使用神像？",
                nameof(AutoExplorerConfig.HandleChests) => "自动探索是否应撬锁并拾取宝箱？",
                nameof(AutoExplorerConfig.AutoDescend) => "清理楼层后是否应下到下一层？",
            ...
            "ZHTW" => id switch
            {
                ...
                nameof(AutoExplorerConfig.StopOnUnusableShrine) => "自動探索是否應停在無法自動使用的神殿（材料/防具）旁？",
                nameof(AutoExplorerConfig.HandleStatues) => "自動探索是否應使用神像？",
                nameof(AutoExplorerConfig.HandleChests) => "自動探索是否應撬鎖並拾取寶箱？",
                nameof(AutoExplorerConfig.AutoDescend) => "清理樓層後是否應下到下一層？",
            ...
            _ => id switch
            {
                ...
                nameof(AutoExplorerConfig.StopOnUnusableShrine) => "Should AutoExplore stop next to shrines it can't auto-use (material/armor)?",
                nameof(AutoExplorerConfig.HandleStatues) => "Should AutoExplore use god statues?",
                nameof(AutoExplorerConfig.HandleChests) => "Should AutoExplore lockpick and loot chests?",
                nameof(AutoExplorerConfig.AutoDescend) => "Should AutoExplore descend when the floor is cleared?",
